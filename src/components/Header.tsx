...
export default function Header() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 h-16 bg-gradient-to-b from-[#0f1419] to-[#0f1419]/95 backdrop-blur-md border-b border-white/10 z-50 px-4 md:px-6 flex items-center justify-between">
            {/* Left: Logo & Toggle */}
            <div className="flex items-center gap-4">
                ...
                {/* Mobile Hamburger (could open a drawer, for now just toggle/placeholder) */}
                <button
            ...
            <div className="flex items-center gap-2 md:gap-4">
                <button className="p-2 hover:bg-white/10 rounded-full transition-colors relative group">
                    <Search className="w-5 h-5 text-foreground md:hidden" />
